package me.sfclog.entitymodels.dataconverter;

import com.google.gson.Gson;
import me.sfclog.entitymodels.MetadataHandler;
import me.sfclog.entitymodels.utils.Developer;
...
public class FileModelConverter {
    ...
    public FileModelConverter(File file) {
        ...
        for (int i = 0; i < texturesValues.size(); i++) {
            ...
            if (!imageSize.containsKey(imageName)) try {
                ...
                File imageFile = new File(MetadataHandler.PLUGIN.getDataFolder().getAbsolutePath() + File.separatorChar + "output" + File.separatorChar + "EntityModels" + File.separatorChar + "assets" + File.separatorChar + "entitymodels" + File.separatorChar + "textures" + File.separatorChar + "entity" + File.separatorChar + imageName);
    ...
    private Map<String, Map<String, Object>> generateFileTextures() {
        ...
        for (Integer key : textures.keySet())
            textureContents.put("" + key, "entitymodels:entity/" + textures.get(key));
