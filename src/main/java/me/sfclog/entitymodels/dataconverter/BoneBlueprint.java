...
public class BoneBlueprint {
    ...
    public BoneBlueprint(double projectResolution, Map<String, Object> boneJSON, HashMap<String, Object> values, Map<String, Map<String, Object>> textureReferences, String modelName, BoneBlueprint parent, SkeletonBlueprint skeletonBlueprint) {
        ...
        this.boneName = "entitymodels:" + modelName.toLowerCase() + "/" + originalBoneName.toLowerCase();
    ...
    private String getModelDirectory(String modelName) {
        return MetadataHandler.PLUGIN.getDataFolder().getAbsolutePath() + File.separatorChar + "output" + File.separatorChar + "EntityModels" + File.separatorChar + "assets" + File.separatorChar + "entitymodels" + File.separatorChar + "models" + File.separatorChar + modelName;
    }
