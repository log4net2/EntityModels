...
import me.sfclog.entitymodels.utils.LoopType;
...
public class AnimationBlueprint {
    ...
    public AnimationBlueprint(Object data, String modelName, SkeletonBlueprint skeletonBlueprint) {
        ...
        try {
            ...
            Developer.warn("Failed to get animation data! Model format is not as expected, this version of BlockBench is not compatible with EntityModels!");
            e.printStackTrace();
            return;
        }
