package me.sfclog.entitymodels.customentity.core;

import me.sfclog.entitymodels.dataconverter.BoneBlueprint;
import me.sfclog.entitymodels.entities.ModelArmorStand;
import me.sfclog.entitymodels.utils.QuaternionHelper;
...
import static me.sfclog.entitymodels.utils.QuaternionHelper.quaternionToEuler;
...
public class Bone {
    ...
    public void transform() {
        ...
        if (!armorStand.getLocation().equals(targetAnimationLocation) && Double.isFinite(targetAnimationLocation.getX()) && Double.isFinite(targetAnimationLocation.getY()) && Double.isFinite(targetAnimationLocation.getZ()))
            armorStand.teleportAsync(targetAnimationLocation);
